...
import { Home, Sparkles, CreditCard, User, LogOut, Lightbulb } from 'lucide-react'
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-foreground selection:bg-primary/30">
      ...
      <main className="w-full max-w-full py-6 px-3 pb-32 md:py-8 md:px-4 md:pb-8 overflow-x-hidden" style={{ boxSizing: 'border-box' }}>
