...
var locRU = Localization{
	...
	SubsTextModelsMini: "Текстовые модели: GPT-5 nano",
	SubsTextModelsHi:   "Текстовые модели: Gemini 3 Flash, GPT-5 nano",
	...
	ExtrasImage:       "Генерации изображений",
	ExtrasMusico:      "Генерации музыки",
	ExtrasVideos:      "🎬 Видео токены",
	...
	ModelsCostFrom:         "<b>Расход: от %d запросов</b>",
	ModelsCostFromSingular: "<b>Расход: от %d запроса</b>",
	...
	ModelsCatChat:          "💬 Текст",
	InstrNanoBanana:        "<tg-emoji emoji-id=\"5382259076098957171\">📸</tg-emoji> В 1 сообщении отправьте 1 или более фото, в подписи укажите что хотите изменить (промпт).",
	InstrTextModels:        "<tg-emoji emoji-id=\"5382259076098957171\">📸</tg-emoji> Отправьте любое сообщение в чат.",
	InstrSunoMusic:         "<tg-emoji emoji-id=\"5382259076098957171\">📸</tg-emoji> Отправьте в чат описание музыки, которую хотите создать.",
	InstrVeo3Video:         "<tg-emoji emoji-id=\"5382259076098957171\">📸</tg-emoji> Отправьте 1 фото с подписью — опишите, какое видео хотите получить.",
	...
	ErrServiceError:             "Нейросеть вернула ошибку. Прочитайте правила нашего бота /rules, переформулируйте ваш запрос и отправьте его снова.",
...
var locEN = Localization{
	...
	SubsTextModelsMini: "Text models: GPT-5 nano",
	SubsTextModelsHi:   "Text models: Gemini 3 Flash, GPT-5 nano",
	...
	ModelKlingMotion:            "Motion transfer to a character. Send a character photo + reference motion video. Cost: 720p=10 tokens/sec, 1080p=15 tokens/sec. Average wait time 2–5 minutes.",
